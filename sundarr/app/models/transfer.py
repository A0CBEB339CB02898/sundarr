...
class TransferTask(TimestampMixin, Base):
    ...
    link_id: Mapped[str | None] = mapped_column(ForeignKey("resource_links.id"))
    ...
    source_config_snapshot: Mapped[dict[str, Any] | None] = mapped_column(JsonObject)
    sync_seen_file_id: Mapped[str | None] = mapped_column(Text)
    binding_id: Mapped[str | None] = mapped_column(Text)
