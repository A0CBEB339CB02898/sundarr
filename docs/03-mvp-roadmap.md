...
Phase 7 Web Console: 进行中，Phase 7.1 Web Console Shell、Phase 7.2 Status Page、Phase 7.3 Transfers Page 和 Phase 7.4 Storage Page 已完成；真实供应商开发和集成测试在该阶段形成可操作前端界面后再启动。
