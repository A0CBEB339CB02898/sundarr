...
发现首页采用内容探索式导航。顶部一级入口固定为“热门 / 电影 / 剧集 / 动漫 / 综艺”，热门位于首位；搜索框独立位于同一导航区域右侧。热门入口继续展示热门电影、热门剧集、分类推荐和关注更新分区，其他入口展示对应内容列表。动漫和综艺是由当前 Provider 题材能力映射出的探索预设，不扩展公共 `MediaType` 枚举，也不得在 Provider 不支持时伪造结果。
