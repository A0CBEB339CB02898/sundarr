...
Phase 10.0 质量基线收口、Phase 10.1 通用插件宿主、Phase 10.2 媒体发现 Core 结构性收口和 Phase 10.3 真实插件均已完成。Plugin API v2 已于 2026-08-31 冻结；Core 当前锁定 `sundarr-sources@a10b902` 与 `sundarr-plugin@87c6c69`，TMDb、SeedHub、豆瓣目录和豆瓣想看真实纵向切片均已通过。当前优先任务是 Phase 10.4 发布前可靠性收口；冻结后兼容性修改必须保持向后兼容，破坏性变更需要新的协议版本。
