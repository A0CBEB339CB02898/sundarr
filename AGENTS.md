...
Phase 10.0 质量基线收口、Phase 10.1 通用插件宿主和 Phase 10.2 媒体发现 Core 结构性收口已完成。Phase 10.3 的 TMDb 真实纵向切片已于 2026-08-31 通过并冻结 Plugin API v2；SeedHub SOURCE 已从官方 GitHub 锁定 `a10b902`，实时 API、详情收藏、启动恢复和 Web Console 真实回归也已通过；豆瓣目录已从官方插件仓库锁定 `56f47c1`，真实搜索、热门、分类、详情、多 Provider 选择、失败隔离、启动恢复和海报防盗链兼容均已通过。当前优先任务是豆瓣想看插件。冻结后兼容性修改必须保持向后兼容，破坏性变更需要新的协议版本。
